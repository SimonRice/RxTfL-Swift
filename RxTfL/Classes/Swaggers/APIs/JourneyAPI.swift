...
open class JourneyAPI: APIBase {
    ...
    open class func journeyJourneyResults(from: String, to: String, via: String? = nil, nationalSearch: Bool? = nil, date: String? = nil, time: String? = nil, timeIs: TimeIs_journeyJourneyResults? = nil, journeyPreference: JourneyPreference_journeyJourneyResults? = nil, mode: [String]? = nil, accessibilityPreference: [String]? = nil, fromName: String? = nil, toName: String? = nil, viaName: String? = nil, maxTransferMinutes: String? = nil, maxWalkingMinutes: String? = nil, walkingSpeed: WalkingSpeed_journeyJourneyResults? = nil, cyclePreference: CyclePreference_journeyJourneyResults? = nil, adjustment: String? = nil, bikeProficiency: [String]? = nil, alternativeCycle: Bool? = nil, alternativeWalking: Bool? = nil, applyHtmlMarkup: Bool? = nil, useMultiModalCall: Bool? = nil, walkingOptimization: Bool? = nil, completion: @escaping ((_ data: ItineraryResult?,_ error: Error?) -> Void)) {
        journeyJourneyResultsWithRequestBuilder(from: from.asParameter, to: to.asParameter, via: via.asParameter, nationalSearch: nationalSearch.asParameter, date: date.asParameter, time: time.asParameter, timeIs: timeIs.asParameter, journeyPreference: journeyPreference.asParameter, mode: mode.asParameter, accessibilityPreference: accessibilityPreference.asParameter, fromName: fromName.asParameter, toName: toName.asParameter, viaName: viaName.asParameter, maxTransferMinutes: maxTransferMinutes.asParameter, maxWalkingMinutes: maxWalkingMinutes.asParameter, walkingSpeed: walkingSpeed.asParameter, cyclePreference: cyclePreference.asParameter, adjustment: adjustment.asParameter, bikeProficiency: bikeProficiency.asParameter, alternativeCycle: alternativeCycle.asParameter, alternativeWalking: alternativeWalking.asParameter, applyHtmlMarkup: applyHtmlMarkup.asParameter, useMultiModalCall: useMultiModalCall.asParameter, walkingOptimization: walkingOptimization.asParameter).execute { (response, error) -> Void in
